...
module.exports = class FormLayout extends Observable {
    ...
    makeSection(section) {
        const sectionElement = dataent.ui.add('div', 'form-section', this.form);
        const sectionHead = dataent.ui.add('div', 'form-section-head', sectionElement);
        const sectionBody = dataent.ui.add('div', 'form-section-body', sectionElement);

        if (section.title) {
            const head = dataent.ui.add('h6', 'uppercase', sectionHead);
        ...
        if (section.columns) {
            ...
            for (let column of section.columns) {
                let columnElement = dataent.ui.add('div', 'col', sectionBody);
