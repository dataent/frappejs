...
const Modal = require('dataentjs/client/ui/modal');
...
module.exports = class ModelTable {
    ...
    getControl(field, parent) {
        ...
        const controls = require('dataentjs/client/view/controls');
    ...
    getControlModal(field) {
        this.modal = new Modal({
            title: dataent._('Edit {0}', field.label),
            body: '',
            primary: {
                label: dataent._('Submit'),
                action: (modal) => {
