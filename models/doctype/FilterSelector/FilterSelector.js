...
module.exports = {
        ...
        },
        {
            ...
            formula: async (doc) => {
                if (doc._lastFilterGroup !== doc.filterGroup) {
                    ...
                    if (doc.filterGroup) {
                        doc.items = [];
                        const filterGroup = await dataent.getDoc('FilterGroup', doc.filterGroup);
    ...
    formEvents: {
        ...
        refresh: (form) => {
            ...
            dataent.getMeta('FilterItem').getField('field').getOptions = () => {
                return dataent.getMeta(form.doc.forDocType).fields.map((f) => {
